...
namespace External
{
    ...
    {
        public Task<T> GetRequest<T>(string uri, IDictionary<string, string>? headers = null);
    }
    public class HttpClient : IHttpClient
    {
        ...
        public async Task<T> GetRequest<T>(string uri, IDictionary<string, string>? headers)
        {
